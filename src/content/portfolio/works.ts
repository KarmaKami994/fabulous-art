...
export const portfolioWorks: PortfolioWork[] = [
  ...
  },
  {
    ...
    description: {
      ...
      en: 'Three women, moving as one. Inspired by the ancient Greek goddesses of beauty, joy and charm - this piece is a tribute to grace, connection and flow. A quiet dance captured in lines and light.',
    },
  },
  {
    title: 'Purity',
